...
const SECTIONS = [
  {
    ...
    tiles: [
      ...
      { title:'Profile Photo Approvals',  desc:'Personnel → Photo Approvals tab',                    path:'/personnel' },
      ...
      { title:'Performance Reviews',      desc:'Employee evaluations and scoring',                   path:'/reviews' },
      { title:'Recognition System',       desc:'HR → Recognition tab',                              path:'/hr' },
      { title:'Position Management',      desc:'Settings → Team & Roles tab',                        path:'/settings' },
    ],
  },
  {
    id: 'ops',
    ...
    tiles: [
      ...
      { title:'Shift Bidding',           desc:'Scheduling → Shift Bids tab',                        path:'/scheduling' },
    ],
  },
  {
    id: 'incidents',
    ...
    tiles: [
      ...
      { title:'AI Incident Analysis',     desc:'Incidents → AI Analysis tab',                        path:'/incidents' },
      { title:'State Licensing',          desc:'Settings → State Licensing tab',                     path:'/settings' },
  ...
  },
  {
    ...
    icon: 'briefcase',
    tiles: [
      { title:'Client Management',        desc:'Manage client accounts',                             path:'/clients' },
      { title:'Client Onboarding',        desc:'Clients → Onboarding tab',                           path:'/clients' },
      { title:'Site Management',          desc:'Manage job sites and locations',                     path:'/sites' },
      { title:'Client Contracts',         desc:'Clients → Contracts tab',                            path:'/clients' },
  ...
  },
  {
    ...
    tiles: [
      ...
      { title:'Badge Management',         desc:'Training → Badges tab',                              path:'/training' },
      { title:'Certificate Templates',    desc:'Training → Certificates tab',                        path:'/training' },
      { title:'Training Suggestions (AI)',desc:'Training → AI Suggestions tab',                       path:'/training' },
    ],
  },
  {
    id: 'billing',
  ...
  },
  {
    ...
    tiles: [
      ...
      { title:'Policy Management',        desc:'HR → Policy Management tab',                         path:'/hr' },
      ...
      { title:'DM Monitor (Admin)',        desc:'Messaging → DM Monitor tab',                         path:'/messaging' },
  ...
  },
  {
    ...
    tiles: [
      ...
      { title:'AI Reports',               desc:'Reports → AI Summary tab',                           path:'/reports' },
      { title:'Report Automation',        desc:'Reports → Automation tab',                           path:'/reports' },
      { title:'Weekly Site Reports',      desc:'Reports → Site Reports tab',                         path:'/reports' },
    ],
  },
  {
    id: 'data',
