...
export const NAV_ITEMS = [
  { section:'Operations', items:[
    ...
    { id:'personnel', label:'Personnel', path:'/personnel', icon:'user', roles:['super_admin','chief','lieutenant','sergeant','hr','office_staff'] },
    { id:'scheduling', label:'Schedule', path:'/scheduling', icon:'calendar', roles:['super_admin','chief','lieutenant','sergeant','corporal','officer','office_staff'] },
    { id:'open-shifts', label:'Open Shifts', path:'/open-shifts', icon:'briefcase', roles:['super_admin','chief','lieutenant','sergeant','corporal'] },
    ...
    { id:'time-off', label:'Time Off', path:'/time-off', icon:'umbrella', roles:['super_admin','chief','lieutenant','sergeant','corporal','officer','hr','accounting','office_staff'] },
    { id:'availability', label:'Availability', path:'/availability', icon:'calendar-check', roles:['super_admin','chief','lieutenant','sergeant','corporal','officer','hr','accounting','office_staff'] },
    { id:'incidents', label:'Incident Reports', path:'/incidents', icon:'alert-triangle', badge:true, roles:['super_admin','chief','lieutenant','sergeant','corporal','officer','hr'] },
  ...
  { section:'Field', items:[
    ...
    { id:'patrol', label:'Patrol Logs', path:'/patrol', icon:'shield', roles:['super_admin','chief','lieutenant','sergeant','corporal','officer'] },
  ...
  { section:'Admin', items:[
    ...
    { id:'hr', label:'HR & Documents', path:'/hr', icon:'folder', roles:['super_admin','chief','lieutenant','hr','office_staff'] },
    { id:'invoices', label:'Invoices', path:'/invoices', icon:'file-text', roles:['super_admin','chief','accounting'] },
    { id:'payroll',  label:'Payroll',  path:'/payroll',  icon:'dollar-sign', roles:['super_admin','chief','lieutenant','accounting'] },
    { id:'uniforms', label:'Uniforms', path:'/uniforms', icon:'tag', roles:['super_admin','chief','lieutenant','sergeant','corporal','officer','office_staff'] },
    ...
    { id:'audit',    label:'Audit Log', path:'/audit',    icon:'list',        roles:['super_admin','chief'] },
